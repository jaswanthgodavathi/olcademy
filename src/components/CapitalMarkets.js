...
import videoSrc from "../images/videos/capitalmarkets.mp4"; // Updated video source
// Import the images for the boxes
import image1 from "../images/capitalmarketsbox1.jpg";
import image2 from "../images/capitalmarketsbox2.jpg";
import image3 from "../images/capitalmarketsbox3.jpg";
import image4 from "../images/capitalmarketsbox4.jpg";
...
const CapitalMarkets = () => {
  ...
  const boxes = [
    {
      image: image1,
      title: "Expertise in Capital Markets",
      info: "We help private equity investors, endowments, and sovereign wealth funds drive long-term performance.",
    },
    {
      image: image2,
      title: "Resilience & Adaptability",
      info: "Our solutions help you navigate market volatility and high transaction volumes with confidence.",
    },
    {
      image: image3,
      title: "Sustainability Leadership",
      info: "We enable the transition to low-carbon economies and integrate sustainable business practices.",
    },
    {
      image: image4,
      title: "Strategic Investments",
      info: "Guiding infrastructure investments and low-carbon transitions for a sustainable future.",
    },
  ];
  ...
  const challengesSolutions = [
    {
      ...
      info: "We provide resilience-focused strategies and insights to navigate unpredictable market conditions and achieve stability.",
    },
    {
      title: "Sustainable Practices",
      info: "We guide organizations in adopting low-carbon transitions and integrating sustainability into business practices, ensuring long-term profitability.",
    },
    {
      title: "Managing High Transaction Volumes",
      info: "We streamline transaction processes, enabling efficiency and precision in handling high-volume operations in growing markets.",
    },
    {
      title: "Long-Term Growth Strategies",
      info: "We assist in building resilient financial practices to ensure sustainable, adaptable growth in capital markets.",
    },
  ];
      ...
      <div className="relative w-full h-screen bg-black text-white overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 text-lg md:text-xl font-medium text-gray-100">
            Driving resilience, adaptability, and sustainable growth in the capital markets sector.
          </p>
        </div>
      </div>
      ...
      <div className="w-full bg-white py-24 md:py-32 px-6 md:px-12 text-center">
        <div className="mx-auto max-w-screen-md">
          <blockquote className="text-blue-600 italic text-3xl md:text-4xl font-serif mt-6 max-w-3xl mx-auto">
            "Olcademy empowers private equity investors and sovereign wealth funds with strategies to build resilience, integrate sustainability, and maximize long-term growth."
          </blockquote>
        </div>
      </div>
